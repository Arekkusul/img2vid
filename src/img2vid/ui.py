...
def _run(image, prompt, width, height, frames, steps, cfg_scale, frame_rate, seed):
...
def build_demo() -> gr.Interface:
    demo = gr.Interface(
        ...
        inputs=[
            ...
            gr.Slider(4, 50, value=30, step=1, label="Steps"),
            gr.Slider(1.0, 10.0, value=3.0, step=0.5, label="CFG scale"),
