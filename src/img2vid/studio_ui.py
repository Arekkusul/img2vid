...
from img2vid.library_ui import build_demo as build_library_demo
from img2vid.ui import build_demo as build_video_demo


def build_demo() -> gr.Blocks:
    """Combine the standalone video (LTX-2.5) and image (Krea 2) UIs, plus a video library
    browser, into one tabbed app.
    ...
    return gr.TabbedInterface(
        [build_video_demo(), build_image_demo(), build_library_demo()],
        tab_names=["Video (LTX-2.5)", "Image (Krea 2)", "Library"],
